...
/**
*/
class MultichannelTemplateAudioProcessorEditor  : public AudioProcessorEditor, private Timer
{
public:
    MultichannelTemplateAudioProcessorEditor (MultichannelTemplateAudioProcessor&, AudioProcessorValueTreeState&);
    ~MultichannelTemplateAudioProcessorEditor() override;
...
private:
    ...
    MultichannelTemplateAudioProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MultichannelTemplateAudioProcessorEditor)
};
