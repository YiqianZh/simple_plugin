...
//==============================================================================
MultichannelTemplateAudioProcessor::MultichannelTemplateAudioProcessor()
: AudioProcessorBase (
...
//==============================================================================
int MultichannelTemplateAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int MultichannelTemplateAudioProcessor::getCurrentProgram()
{
    return 0;
}

void MultichannelTemplateAudioProcessor::setCurrentProgram (int index)
{
    ignoreUnused (index);
}

const String MultichannelTemplateAudioProcessor::getProgramName (int index)
{
    ignoreUnused (index);
    return {};
}

void MultichannelTemplateAudioProcessor::changeProgramName (int index, const String& newName)
{
    ignoreUnused (index, newName);
}

//==============================================================================
void MultichannelTemplateAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void MultichannelTemplateAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

void MultichannelTemplateAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer&)
{
...
//==============================================================================
bool MultichannelTemplateAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* MultichannelTemplateAudioProcessor::createEditor()
{
    return new MultichannelTemplateAudioProcessorEditor (*this, parameters);
}

//==============================================================================
void MultichannelTemplateAudioProcessor::getStateInformation (MemoryBlock& destData)
{
...
void MultichannelTemplateAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
//==============================================================================
void MultichannelTemplateAudioProcessor::parameterChanged (const String &parameterID, float newValue)
{
...
void MultichannelTemplateAudioProcessor::updateBuffers()
{
...
//==============================================================================
std::vector<std::unique_ptr<RangedAudioParameter>> MultichannelTemplateAudioProcessor::createParameterLayout()
{
...
{
    return new MultichannelTemplateAudioProcessor();
}
